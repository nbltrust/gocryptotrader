...
[![GoDoc](https://godoc.org/github.com/nbltrust/gocryptotrader?status.svg)](https://godoc.org/github.com/nbltrust/gocryptotrader/communications/smsglobal)
...
+ [Enable via configuration](https://github.com/nbltrust/gocryptotrader/tree/master/config#enable-communications-via-config-example)
...
+ Code must adhere to our [coding style](https://github.com/nbltrust/gocryptotrader/blob/master/doc/coding_style.md).
+ Pull requests need to be based on and opened against the `master` branch.

## Donations

<img src="https://github.com/nbltrust/gocryptotrader/blob/master/web/src/assets/donate.png?raw=true" hspace="70">
